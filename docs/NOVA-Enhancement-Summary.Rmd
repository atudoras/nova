...
```{r metric-plot-fig, echo=FALSE, eval=TRUE, out.width="80%", fig.cap="Average PCA trajectories across conditions — an example of the per-condition summary output style that `plot_mea_metric()` replicates for individual metrics."}
knitr::include_graphics("user-guide/figures/traj_combined_avg.png")
```
